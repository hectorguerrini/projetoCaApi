module.exports = function (app) {
	...
	app.route('/vendas/excel/download/:id_festa/:tipo')
		.get(list.gerarExcel);
	app.route('/vendas/get_produtos')
		.get(list.getProdutos);
	app.route('/vendas/update_produto')
		.post(list.updateVendaProduto);
	app.route('/vendas/delVenda')
		.post(list.delete);
	app.route('/vendas/novo_produto')
		.post(list.novoProduto);
};
